...
# Testing hypothesis: 
# Y~Gamma given linear part and distrubution are correctely specified.
# Test methods: MCCM1    
##Choose n=100,200,300

figureB18B2=function(n=100,B=100,su2=1,total=100,M=100)
 {
  set.seed(333)
   ...
   while(jj<total)
    {
      ...
      gmis=function(x){(1/(sqrt(2*pi)))*exp((-x^2)/2)}
      alph=1+phi               
...
#btime=Sys.time()
#figureB18B2(100,100,1,total=100,M=100)
#Sys.time()-btime
