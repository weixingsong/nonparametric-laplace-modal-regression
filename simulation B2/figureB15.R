...
figureB15=function(n=100,B=100,su2=1)
 {
  set.seed(111)
...
#####################################
  ...
  while(jj<total)
   ...
   cat("\n")
   cat("Simulation Results in Figure B.15","\n")
   cat("n =",n,"","B =",B,"","su2 =",su2,"\n\n")
   cat("Empirical Level of MCCM2","\n\n")


   plot(pv,fp1,type="l",
     xlab = paste0("Nominal Significance Level (n=", n, ")"),
     ylab = "Rejection Rate")
   lines(pv,pv,lty=3)
...
btime=Sys.time()
postscript("results/figureB15.eps", width = 16, height = 6, 
