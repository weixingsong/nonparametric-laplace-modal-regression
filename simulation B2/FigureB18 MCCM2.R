...
# Testing hypothesis: 
# Y~Gamma given link function and linear part are correctely specified.（Model B.4）
# Test methods: MCCM2
##Choose n=100,200,300

figureB18B4M2=function(n=100,B=100,su2=1,total=100,M=100)
 {
  set.seed(555)
...
#btime=Sys.time()
#figureB18B4M2(100,100,1,total=100,M=100)
#Sys.time()-btime
