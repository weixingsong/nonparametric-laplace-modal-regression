...
sink("results/table7.txt")
cat("# Simulation Results in Table 7 \n")
cat("# \n")
table7(50)
sink()

postscript("results/figure12.eps", width = 8, height = 6, 
