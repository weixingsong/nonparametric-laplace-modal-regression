...
testDTCK=function(B=50)
 {
  ...
  betts=optim(par=c(-1.58,0.27,0.27,5),fn=mccl,mydata=mydata)
  ...
  mytest1=test.CM(as.vector(R), boot = 100, alpha = 0.05)$pvalue#$Decision
  mytest2=test.KS(as.vector(R), boot = 100, alpha = 0.05)$pvalue#$Decision
