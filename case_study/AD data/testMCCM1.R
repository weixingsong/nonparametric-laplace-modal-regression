...
testMCCM1=function(B=50,M=100,link_type=1, covu_type=1) 
 {
  # mode-link function 
  ...
  for(j in seq(n))
   ...
   bett=optim(par=c(-0.71,-0.15,-0.08,2.93),fn=mccl,mydata=mydata)$par
  ...
  # choice sigmahat:(hatsigmaz-hatsigmau)+#
   ...
   while(mm<M)
   {
    ...
    est=optim(par=c(-0.71,-0.15,-0.08,2.93),fn=mccl,mydata=mydata)
