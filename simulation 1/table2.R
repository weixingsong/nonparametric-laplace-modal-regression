...
# The proposed method MCCL: Btnumsum( stdev correspond to empirical standard devitation--s.d.), 
...
table2=function(n=200, B=100, su2=1) 
{
  # mode-link function
...
#MCCL  0.069 0.074 0.036 0.038 0.036 0.039 0.122 0.127 0.731 0.753
#      (0.007)     (0.005)     (0.005)     (0.016)     (0.135)    
#Naive 0.062 0.066 0.027 0.028 0.028 0.029 0.1 0.102   0.52 0.542 
#      (0.006)     (0.003)     (0.003)     (0.01)      (0.069)    
#> Sys.time()-btime
#Time difference of 1.515324 hours
##########################