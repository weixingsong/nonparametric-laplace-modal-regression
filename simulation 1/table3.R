...
table3=function(n=200,B=100,su2=0.25)
 {
  set.seed(1234)
...
#MCCL1 -0.25(0.085)  -0.249(0.042) -0.252(0.04)  -0.243(0.142) 5.148(0.82) 
#MCCL2 -0.252(0.095) -0.251(0.048) -0.254(0.048) -0.24(0.159)  5.172(0.911)
#Naive -0.224(0.084) -0.235(0.04)  -0.237(0.038) -0.305(0.133) 4.894(0.724)
#> Sys.time()-btime
#Time difference of 2.456634 hours
################################