...
figure2=function(n=2000,B=100,su2=1,dependence="TRUE")
 {
  set.seed(1234)
...
########################Naive#############
  ...
  for(kk in seq(total))
   ...
   cat("\n")
   cat("Simulation Results in Figure 2","\n")
   cat("n =",n,"","B =",B,"","su2 =",su2,"\n\n")
   if(dependence=="TRUE")
    {
...
par(mfrow = c(1, 2))
figure2(2000, 100, 1, dependence = "TRUE")
figure2(2000, 100, 1, dependence = "FALSE")
