    # Yao: ylim=c(1.3,4.5) Huang: ylim=c(-1.5,6.5)
    ...
    plot(xseq,mod0cormean,type="l",lwd=2,col="red",ylim=c(-1.8,11),xlab="x",ylab="mean")
    ...
    plot(xseq,mod0cormean,type="l",lwd=2,col="red",ylim=c(-1.5,7.2),xlab="x",ylab="mean")
    for(jj in 1:nrow(tm0cor))
       {
    ...
    plot(xseq,mod0cortmean,type="l",lwd=2,col="red",ylim=c(-0.8,7.2),xlab="x",ylab="trimmed mean")
    lines(xseq, mod0true,  lwd=2, col="black")
    ...
    plot(xseq,mod0cormedian,type="l",lwd=2,col="red",ylim=c(-0.8,7.2),xlab="x",ylab="median")
    lines(xseq, mod0true,  lwd=2, col="black")
