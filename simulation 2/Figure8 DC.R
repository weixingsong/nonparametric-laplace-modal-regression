...
# Test methods: DC    
# Choose n=200,400,600 and beta_4=1.3, where beta_4 refers to the term in the bet2=phi/(g(thetax)+beta_4) in the following code.

figure8DC=function(n=200,B=100,su2=1,bt4=1.3,total=100,M=100)
 {
  set.seed(4444)
...
#btime=Sys.time()
#figure8DC(200,100,1,1.3,total=100,M=100)
#Sys.time()-btime
