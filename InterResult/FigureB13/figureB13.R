# From the intermediate results to the entries in Figure B.13.

library(latex2exp)

figureB13 = read.csv("InterResult//FigureB13//figureB13.csv", skip = 3, header = FALSE)



# Left panel of Figure B.13
result=as.matrix(figureB13[1:4])
Nresult=as.matrix(figureB13[5:8])
...
# Right panel of Figure B.13
result=as.matrix(figureB13[9:12])
Nresult=as.matrix(figureB13[13:16])
